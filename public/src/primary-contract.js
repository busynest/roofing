define(["exports","./application-shell.js","./metadata.js"],function(a,b,c){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.PrimaryContract=a.$primaryContract=void 0;class d extends b.PolymerElement{static get is(){return"primary-contract"}static get properties(){return{business:String,bizAddress:String,bizSales:String,bizPhone:Number,square:{type:Number,value:999,observer:"_deal"},rate:{type:Number,value:999,observer:"_deal"},servicePrice:{type:Number,observer:"_deal"},serviceTaxes:{type:Number,value:888},serviceDeposit:{type:Number,value:777},businessName:{type:String,value:"John"},warrantyYears:{type:Number,value:666}}}constructor(){super()}connectedCallback(){super.connectedCallback(),(0,c.updateMetadata)({title:"Primary Contract",description:"Primary Roofing Contract for Residential Contractors and Customers.",url:document.location.href})}ready(){super.ready(),console.log(this.tagName)}_deal(){this.servicePrice=this.square*this.rate}static get template(){return`
  ...
  `}}a.PrimaryContract=d,customElements.define("primary-contract",d);a.$primaryContract={PrimaryContract:d}});