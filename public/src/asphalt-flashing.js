define(["exports","./application-shell.js","./result-item.js"],function(a,b){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.AsphaltFlashing=a.$asphaltFlashing=void 0;class c extends b.PolymerElement{static get is(){return"asphalt-flashing"}static get properties(){return{ventilationPrices:{type:Array,value:[{x:"Ridge Ventilation",y:24},{x:"Box Ventilaion",y:24},{x:"Plumbing Stacks",y:24}]},flashing:{type:Boolean,notify:!0,observer:"_flashing",value:!1},gable:{type:Number,notify:!0,observer:"_flashing",value:0},gableFlashing:{type:Number,notify:!0,observer:"_flashing"},head:{type:Number,notify:!0,observer:"_flashing",value:0},headFlashing:{type:Number,notify:!0,observer:"_flashing"},back:{type:Number,notify:!0,observer:"_flashing",value:0},backFlashing:{type:Number,notify:!0,observer:"_flashing"},step:{type:Number,notify:!0,observer:"_flashing",value:0},stepFlashing:{type:Number,notify:!0,observer:"_flashing"},valley:{type:Number,notify:!0,observer:"_flashing",value:24},valleyResult:{type:Number,notify:!0,observer:"_flashing"},chimney:{type:Number,notify:!0,observer:"_flashing",value:1},skylights:{type:Number,notify:!0,observer:"_flashing",value:2},cost:{type:Number,notify:!0,observer:"_areaChange",value:24}}}constructor(){super()}connectedCallback(){super.connectedCallback()}ready(){super.ready(),console.log(this.tagName)}_areaChange(a){this._flashing(a)}_flashing(){window.onerror=function(){console.log(arguments)},!1==this.flashing&&(this.$.tin1.setAttribute("style","display:none;"),this.$.tin2.setAttribute("style","display:none;"),this.$.tin3.setAttribute("style","display:none;"),this.$.tin4.setAttribute("style","display:none;")),!0==this.flashing&&(this.$.tin1.setAttribute("style","display:grid; grid-template-columns: 120px 1fr 1.5em; animation-duration: 2s; animation-name: slidein; "),this.$.tin2.setAttribute("style","display:grid; grid-template-columns: 120px 1fr 1.5em; animation-duration: 2s; animation-name: slidein; "),this.$.tin3.setAttribute("style","display:grid; grid-template-columns: 120px 1fr 1.5em; animation-duration: 2s; animation-name: slidein; "),this.$.tin4.setAttribute("style","display:grid; grid-template-columns: 120px 1fr 1.5em; animation-duration: 2s; animation-name: slidein; ")),this.valleyResult=this.valley,this.gableFlashing=this.gable,this.headFlashing=this.head+.5*this.chimney+.5*this.skylights,this.backFlashing=this.back+.5*this.chimney+.5*this.skylights,this.stepFlashing=this.step+.3*this.chimney+.5*this.skylights}static get template(){return`
  <style>
  :host {
...
-->
  `}}a.AsphaltFlashing=c,customElements.define("asphalt-flashing",c);a.$asphaltFlashing={AsphaltFlashing:c}});